<template>
    <li>
        <div class="message-data"><span class="message-data-name">{{ content.username }}</span> <i class="fa fa-circle online"></i><span
            class="message-data-time">{{ formatDate(content.created_at) }}</span> &nbsp; &nbsp;
        </div>
        <div class="message my-message">{{ content.message }}</div>
    </li>
</template>
