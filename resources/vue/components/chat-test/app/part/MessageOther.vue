<template>
    <li class="clearfix">
        <div class="message-data align-right">
            <span class="message-data-time">{{ format(new Date(content.created_at), 'yyyy-MM-dd HH:mm:ss') }}</span> &nbsp; &nbsp;<span
            class="message-data-name">Operator</span> <i class="fa fa-circle me"></i>
        </div>
        <div class="message other-message float-right">{{ content.content }}</div>
    </li>
</template>
