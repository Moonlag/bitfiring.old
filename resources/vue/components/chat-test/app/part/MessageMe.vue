<template>
    <li>
        <div class="message-data"><span class="message-data-name">Me</span> <i class="fa fa-circle online"></i><span
            class="message-data-time">{{ format(new Date(content.created_at), 'yyyy-MM-dd HH:mm:ss') }}</span> &nbsp; &nbsp;
        </div>
        <div class="message my-message">{{ content.content }}</div>
    </li>
</template>
